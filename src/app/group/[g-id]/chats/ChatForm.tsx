...
function page({ params }: Props) {
  ...
  return (
    <>
        <form
            action={sendChat}
            className="flex gap-3 w-full max-w-md bg-white p-3 rounded-xl shadow-md"
        >
            <input
                type="text"
                name="message"
                ...
                required
                className="flex-1 border border-gray-300 rounded-xl px-4 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-orange-400"
            />
            <SendButton />
        </form>
