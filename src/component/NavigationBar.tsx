...
function Navigation() {
  return (
    <div className='fixed w-full top-0 z-49 bg-white shadow-md border-b-2 border-sky-400'>
    <nav className='flex items-center justify-between  p-4 gap-6'>
        ...
        <SignedOut>
            <SignInButton />
            <div className="group rounded-lg bg-sky-500 p-2 text-white cursor-pointer hover:bg-sky-600">
              <SignUpButton />
            </div>
